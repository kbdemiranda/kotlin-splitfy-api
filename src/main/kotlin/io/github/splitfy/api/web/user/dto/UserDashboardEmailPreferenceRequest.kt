...
@Schema(description = "Request payload to update whether a user receives the scheduled KPI summary e-mail")
data class UserDashboardEmailPreferenceRequest(
    @field:Schema(
        description = "Whether this user should receive the scheduled KPI summary e-mail",
        example = "true"
    )
